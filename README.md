...
成功运行可以看到以下效果：
![test_3d](https://github.com/linxiaobo110/QuadrotorFly/blob/master/Doc/Images/test_3d.png)
运行结束后在画面单击可以看整个过程的飞行曲线
![test_2d](https://github.com/linxiaobo110/QuadrotorFly/blob/master/Doc/Images/test_2d.png)
...
在spyder下的运行效果：
![spyder_effect](https://github.com/linxiaobo110/QuadrotorFly/blob/master/Doc/Images/spyder_effect.png)
...
选择指定文件夹
![dir_spyderSelect](https://github.com/linxiaobo110/QuadrotorFly/blob/master/Doc/Images/dir_spyderSelect.png)
选择QuadrotorFly目录
![dir_spyder_set](https://github.com/linxiaobo110/QuadrotorFly/blob/master/Doc/Images/dir_spyder_set.png)

## Spyder图形渲染设置
选择tool->preferences
![spyder_qt5set1](https://github.com/linxiaobo110/QuadrotorFly/blob/master/Doc/Images/spyder_qt5set1.png)
设置合适的渲染工具，不是inline
![spyder_qt5set2](https://github.com/linxiaobo110/QuadrotorFly/blob/master/Doc/Images/spyder_qt5set2.png)
